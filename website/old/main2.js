...
//import { double } from 'testimport,js';
    ...
    var popUpTable = `<div class="row" id="pop-up-container">
                        ...
                        <div class="row" id="pop-up-container">
                            <div class="column" id="pop-up-value-column">
                                <p id="pop-up-value"> ${Math.round(userData[i].val)} </p>
                            </div>
                            <div class="column" id="pop-up-value-column">
                                <p id="pop-up-unit"> ${userData[i].unit} </p>
                            </div>
                        </div>`;
    }
...
async function viewMap(userData, pop, bounds) {
    ...
    /*
    for (var i=0; i<userData.length; i++){
        var start = userData[i].region_from;
        var end   = userData[i].region_to;
        console.log(userData[i].coords_from);
...
for (var i=0; i<lyrGroup.length; i++){
    console.log(lyrGroup.getLayer(i))
}
